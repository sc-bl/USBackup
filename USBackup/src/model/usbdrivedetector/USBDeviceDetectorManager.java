        ...
        public void run() {
            try {
                while (!Thread.currentThread().isInterrupted()) {
                    try {
                        System.out.println ( "Polling refresh task is running");
                        ...
                        System.out.println ( "Error while refreshing device list" + e);
                    }

                    sleep(pollingInterval);
                }
            } catch (InterruptedException ex) {
                System.out.println ( "Stopping polling thread" + ex);
            }
        }
    }
}
